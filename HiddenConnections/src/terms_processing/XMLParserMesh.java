...
public static void main(String argv[]) {
    ...
    extractEntryTermsMeshHeadings(MESH_DESC2017_XML, "DescriptorRecord", "DescriptorUI", "DescriptorName");
    //extractEntryTermsMeshHeadings("mesh/supp2017.xml", "SupplementalRecord", "SupplementalRecordUI", "SupplementalRecordName");
    extractEntryTermsMeshHeadings(MESH_QUAL2017_XML, "QualifierRecord", "QualifierUI", "QualifierName");
